<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="DetailHocBa.aspx.cs" Inherits="TSDH.web.Application.admin.WebForm2" %>
    ...
    <div class="row" style="height: 90vh;">
        ...
        <div class="col-md-10 grid-view" style="padding: 40px;">
            ...
            <div class="row d-flex justify-content-md-center ">
                ...
                <asp:Label ID="Label17" runat="server" Text="Nguyện vọng" CssClass="form-control col-md-2 my-1 title"></asp:Label>
                <asp:Label ID="nv" runat="server" Text="tên ngành" CssClass="form-control col-md-4 my-1 content"></asp:Label>
                <asp:Label ID="Label19" runat="server" Text="Tổ hợp XT" CssClass="form-control col-md-2 my-1 title"></asp:Label>
                <asp:Label ID="tohop" runat="server" Text="A00" CssClass="form-control col-md-4 my-1 content"></asp:Label>
                <div class="col-md-6"></div>

                <asp:Label ID="Label22" runat="server" Text="Điểm" CssClass="form-control col-md-2 my-1 title"></asp:Label>
                <asp:Label ID="diem" runat="server" Text="30" CssClass="form-control col-md-4 my-1 content" Style="left: 0px; top: 0px"></asp:Label>

                <asp:Label ID="Label24" runat="server" Text="Ảnh học bạ lớp 10" CssClass="form-control col-md-6 my-1 content"> </asp:Label>
                <asp:Label ID="Label25" runat="server" Text="Ảnh học bạ lớp 11" CssClass="form-control col-md-6 my-1 content" Style="left: 0px; top: 0px"></asp:Label>
                ...
                <asp:Label ID="Label26" runat="server" Text="Ảnh học bạ lớp 12" CssClass="form-control col-md-6 my-1 content"></asp:Label>
