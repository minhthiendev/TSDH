...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HocBa.aspx.cs" Inherits="TSDH.web.Application.Con_lau_moi_tim_duoc_trang_admin_nay_nha.HocBa" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản Lý Học Bạ</title>
                ...
                <ul class="nav collapse navbar-collapse d-flex justify-content-end">
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="dropdown-menu-right dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="/Con-lau-moi-tim-duoc-trang-admin-nay-nha/profile">Profile</a>
                            <a class="dropdown-item" href="/Con-lau-moi-tim-duoc-trang-admin-nay-nha/setting">setting</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="/Con-lau-moi-tim-duoc-trang-admin-nay-nha/Login">Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
